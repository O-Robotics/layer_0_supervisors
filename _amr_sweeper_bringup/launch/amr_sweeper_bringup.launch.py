...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("fsm_state_topic", default_value="fsm/supervisor/fsm_state"),
        DeclareLaunchArgument("fsm_status_topic", default_value="fsm/supervisor/fsm_status"),
