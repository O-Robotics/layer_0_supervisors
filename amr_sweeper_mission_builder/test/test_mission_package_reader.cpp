...
{
  try {
    (void)amr_sweeper_mission_builder::readVda5050MissionPackage(package_path);
...
int main()
{
  try {
    ...
    const auto folder_documents =
      amr_sweeper_mission_builder::readVda5050MissionPackage(folder_package);
    ...
    const auto root_documents =
      amr_sweeper_mission_builder::readVda5050MissionPackage(root_zip);
    ...
    const auto nested_documents =
      amr_sweeper_mission_builder::readVda5050MissionPackage(nested_zip);
