 ...
 *      "topic=fsm/supervisor_node/fsm_state;type=amr_sweeper_fsm/msg/FSMState;period_ms=1000;source=state"
 *      "topic=fsm/supervisor_node/fsm_status;type=amr_sweeper_fsm/msg/FSMStatus;period_ms=1000;source=status"
 */
